...
import CategoryMenu from "../container/Category/CategoryMenu";
const { Search } = Input;
...
function Navbar(props) {
  ...
  return (
    <>
      <div
        style={{ position: "fixed", zIndex: "9999", top: 0 }}
        className="w-full"
      >
      ...
      <CategoryMenu anchorEl={anchorEl} setAnchorEl={setAnchorEl} open={open} />
    </>
  );
}
